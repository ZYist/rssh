...
const zh: Messages = {
  ...
  "ai.toolbar.broadcast_on_tip": "广播已开启 —— 批准的命令将同步到选中的终端",
  ...
  "ai.broadcast.collapse": "折叠目标条",
  "ai.broadcast.expand": "展开目标条",
  ...
  "error.dynamic_discovery_parse_failed": "解析 {platform} 动态发现输出失败：{err}",
