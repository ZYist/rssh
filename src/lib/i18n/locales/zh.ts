...
const zh: Messages = {
  ...
  "settings.section.connection_list": "连接清单",
  ...
  "settings.section.dynamic_discovery": "动态发现",
  ...
  "connection.new": "+ 新建连接",
  "connection.empty": "暂无已保存连接",
  "connection.type.ssh": "SSH",
  "connection.type.forward": "端口转发",
  "connection.type.serial": "串口",
  "connection.type.telnet": "Telnet",
  "connection.type": "连接类型",
  "connection.type.ssh_description": "安全 Shell Profile",
  "connection.type.forward_description": "SSH 隧道",
  "connection.type.serial_description": "设备控制台",
  "connection.type.telnet_description": "Telnet 端点",
  "connection.type_locked": "编辑或复制时不能更改连接类型。",
  ...
  "profile.group": "分组",
  "profile.none": "（无）",
  "profile.algorithms": "算法",
  "profile.algorithms.reset": "恢复默认",
  "profile.algorithms.kex": "密钥交换",
  "profile.algorithms.key": "主机密钥",
  "profile.algorithms.cipher": "加密算法",
  "profile.algorithms.mac": "HMAC",
  "profile.algorithms.compression": "压缩",
  "profile.algorithms.empty": "每类至少选择一个算法。",
  // ── Profile 管理（列表）──
  "profile.new": "+ 新建",
  ...
  "dynamic_discovery.new": "+ 新建来源",
  "dynamic_discovery.empty": "暂无动态发现来源",
  "dynamic_discovery.enabled": "启用",
  "dynamic_discovery.platform": "平台",
  "dynamic_discovery.cli": "CLI",
  "dynamic_discovery.refresh_contexts": "刷新 context",
  "dynamic_discovery.test": "测试发现",
  "dynamic_discovery.cli_available": "CLI 已检测到",
  "dynamic_discovery.cli_missing": "未找到 CLI",
  "dynamic_discovery.name_placeholder": "开发容器",
  "dynamic_discovery.context": "Context",
  "dynamic_discovery.context_placeholder": "选择或输入 context",
  "dynamic_discovery.context_empty": "未找到 context",
  "dynamic_discovery.current": "当前",
  "dynamic_discovery.namespace": "Namespace",
  "dynamic_discovery.namespace_placeholder": "留空 = 全部 namespace",
  "dynamic_discovery.shell": "Shell",
  "dynamic_discovery.probe_ok": "已发现 {targets} 个目标",
  "dynamic_discovery.probe_partial": "已发现 {targets} 个目标，{errors} 个来源失败",
  "dynamic_discovery.probe_summary": "上次探测：{targets} 个目标，{errors} 个错误",
  "dynamic_discovery.all_namespaces": "全部 namespace",
  "dynamic_discovery.error.name_required": "名称不能为空",
  "dynamic_discovery.error.cli_unavailable": "{cli} CLI 不可用",
  "dynamic_discovery.error.context_required": "Context 不能为空",
  "dynamic_discovery.error.shell_required": "Shell 不能为空",
  "serial.new": "+ 新建",
  ...
  "telnet.host": "主机",
  "telnet.port": "端口",
  "telnet.echo_mode": "本地回显",
  "telnet.echo.auto": "自动（Telnet 协商）",
  "telnet.echo.on": "始终开启",
  "telnet.echo.off": "始终关闭",
  "telnet.save_script_to_remote": "在加密远程同步中包含登录脚本",
  "telnet.login_script_unavailable": "登录脚本不可用：{error}",
  ...
  "ai.message.rollback": "回退到该消息发送前",
  "ai.message.rollback_confirm_title": "回退上下文？",
  "ai.message.rollback_confirm": "将从上下文中删除这条消息及其后的所有用户和 AI 消息。审计日志不会删除，并会记录本次回退。",
  ...
  "error.ai_context_message_mismatch": "该消息与当前 AI 上下文已不一致，请刷新对话后重试。",
  ...
  "error.profile_algorithms_invalid": "请在 {category} 类别中至少选择一个受支持的算法。",
  ...
  "error.telnet_profile_invalid": "Telnet 配置字段无效：{field}",
  "error.db_wal_checkpoint_busy": "数据库 WAL 正在使用，清理将在下次启动时重试。",
  "error.numeric_arg_invalid": "数值参数无效或超出范围：{field}",
  "error.telnet_login_script_missing": "Telnet 配置 {id} 的加密登录脚本缺失。",
  "error.telnet_login_script_epoch_invalid": "Telnet 登录脚本迁移状态无效：{key}",
  "error.session_id_invalid": "会话标识无效",
  "error.session_id_conflict": "会话「{id}」已存在",
  "error.session_reservation_lost": "会话「{id}」在启动时已被关闭",
  ...
  "error.dynamic_discovery_timeout": "{program} 执行超过 {secs} 秒",
  "error.dynamic_discovery_cli_unavailable": "{program} CLI 不可用",
  "error.dynamic_discovery_command_failed": "{program} 执行失败：{err}",
  "error.dynamic_discovery_settings_invalid": "动态发现设置已损坏：{err}",
  "error.dynamic_discovery_field_required": "动态发现字段「{field}」不能为空",
  "error.dynamic_discovery_field_has_control_char": "动态发现字段「{field}」含控制字符",
  "error.dynamic_discovery_duplicate_id": "动态发现来源 id 重复：{id}",
  "error.dynamic_discovery_parse_failed": "解析 {platform} 动态发现输出失败（{command} 第 {line} 行）：{err}",
  "error.dynamic_discovery_connector_invalid": "动态发现连接器无效",
  ...
  "error.sync_password_empty": "同步密码不能为空",
  "error.sync_auto_pull_password_missing": "自动拉取已开启，但缺少解密密码",
  "error.sync_metadata_invalid": "远端同步元数据无效",
  ...
  "sync.auto_pull_password": "输入自动拉取密码",
  "sync.password": "密码",
  ...
  "sync.auto_pull": "自动拉取",
  "sync.auto_pull_hint": "远端版本更高时自动拉取。",
  "sync.auto_pull_github": "开启 GitHub 自动拉取",
  "sync.auto_pull_webdav": "开启 WebDAV 自动拉取",
  ...
  "settings.cli.outdated": "有可用更新",
  "settings.cli.version": "已安装 v{installed} · 软件内置 v{expected}",
  "settings.cli.version_unknown": "未知",
  "settings.cli.status_error": "CLI 状态检查失败",
  ...
  "settings.cli.cmd.version": "输出 CLI 版本",
  ...
  "settings.cli.cmd.ls_group": "列出连接分组",
  ...
  "settings.cli.cmd.webdav_set": "配置 WebDAV 同步",
  "settings.cli.cmd.webdav_push": "推送配置到 WebDAV",
  "settings.cli.cmd.webdav_pull": "从 WebDAV 拉取配置",
  // 外观遗留项
