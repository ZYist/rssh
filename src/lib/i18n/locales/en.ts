...
const en = {
  ...
  "settings.section.connection_list": "Connection List",
  ...
  "settings.section.dynamic_discovery": "Dynamic Discovery",
  ...
  "connection.empty": "No saved connections",
  "connection.type.ssh": "SSH",
  "connection.type.forward": "Port Forward",
  "connection.type.serial": "Serial",
  "connection.type.telnet": "Telnet",
  "connection.type": "Connection type",
  "connection.type.ssh_description": "Secure shell profile",
  "connection.type.forward_description": "SSH tunnel",
  "connection.type.serial_description": "Device console",
  "connection.type.telnet_description": "Telnet endpoint",
  "connection.type_locked": "The connection type cannot be changed while editing or copying.",
  ...
  "profile.algorithms.reset": "Reset to defaults",
  "profile.algorithms.kex": "Key exchange",
  "profile.algorithms.key": "Host key",
  "profile.algorithms.cipher": "Ciphers",
  "profile.algorithms.mac": "HMAC",
  "profile.algorithms.compression": "Compression",
  "profile.algorithms.empty": "Select at least one algorithm in each category.",
  ...
  "dynamic_discovery.new": "+ New Source",
  "dynamic_discovery.empty": "No dynamic discovery sources",
  "dynamic_discovery.enabled": "Enabled",
  "dynamic_discovery.platform": "Platform",
  "dynamic_discovery.cli": "CLI",
  "dynamic_discovery.refresh_contexts": "Refresh contexts",
  "dynamic_discovery.test": "Test discovery",
  "dynamic_discovery.cli_available": "CLI detected",
  "dynamic_discovery.cli_missing": "CLI not found",
  "dynamic_discovery.name_placeholder": "Development containers",
  "dynamic_discovery.context": "Context",
  "dynamic_discovery.context_placeholder": "Select or type a context",
  "dynamic_discovery.context_empty": "No contexts found",
  "dynamic_discovery.current": "current",
  "dynamic_discovery.namespace": "Namespace",
  "dynamic_discovery.namespace_placeholder": "Empty = all namespaces",
  "dynamic_discovery.shell": "Shell",
  "dynamic_discovery.probe_ok": "Discovered {targets} target(s)",
  "dynamic_discovery.probe_partial": "Discovered {targets} target(s), {errors} source(s) failed",
  "dynamic_discovery.probe_summary": "Last probe: {targets} target(s), {errors} error(s)",
  "dynamic_discovery.all_namespaces": "all namespaces",
  "dynamic_discovery.error.name_required": "Name is required",
  "dynamic_discovery.error.cli_unavailable": "{cli} CLI is not available",
  "dynamic_discovery.error.context_required": "Context is required",
  "dynamic_discovery.error.shell_required": "Shell is required",
  "serial.new": "+ New",
  ...
  "telnet.host": "Host",
  "telnet.port": "Port",
  "telnet.echo_mode": "Local echo",
  "telnet.echo.auto": "Auto (Telnet negotiation)",
  "telnet.echo.on": "Always on",
  "telnet.echo.off": "Always off",
  "telnet.save_script_to_remote": "Include login script in encrypted remote sync",
  "telnet.login_script_unavailable": "Login script unavailable: {error}",
  ...
  "ai.broadcast.count": "{selected}/{total} targets",
  ...
  "ai.message.copy": "Copy message",
  "ai.message.rollback": "Roll back to before this message",
  "ai.message.rollback_confirm_title": "Roll back context?",
  "ai.message.rollback_confirm": "This message and every later user and AI message will be removed from context. The audit log is preserved and will record this rollback.",
  ...
  "ai.audit.summary.command_blocked": "rssh blocked: {cmd} — {reason}",
  ...
  "ai.audit.summary.download_proposed": "Proposed download: {path} (cap {max_mb} MB)",
  ...
  "shortcut.tab.goto": "Switch to Tab 1–9",
  ...
  "error.ai_context_message_mismatch": "This message no longer matches the active AI context. Refresh the conversation and try again.",
  ...
  "error.profile_algorithms_invalid": "Select at least one supported algorithm in the {category} category.",
  ...
  "error.telnet_profile_invalid": "Invalid Telnet profile field: {field}",
  "error.db_wal_checkpoint_busy": "Database WAL cleanup is busy; it will be retried on next startup.",
  "error.numeric_arg_invalid": "Invalid or out-of-range numeric argument: {field}",
  "error.telnet_login_script_missing": "The encrypted Telnet login script is missing for profile {id}.",
  "error.telnet_login_script_epoch_invalid": "Invalid Telnet login-script migration state: {key}",
  "error.session_id_invalid": "Invalid session identifier",
  "error.session_id_conflict": "Session '{id}' already exists",
  "error.session_reservation_lost": "Session '{id}' was closed while it was starting",
  ...
  "error.group_delete_sync_filter_conflict": "This group and Ungrouped have different sync selections. Match them in Sync settings or move the group's connections before deleting it.",
  ...
  "error.dynamic_discovery_timeout": "{program} timed out after {secs}s",
  "error.dynamic_discovery_cli_unavailable": "{program} CLI is not available",
  "error.dynamic_discovery_command_failed": "{program} failed: {err}",
  "error.dynamic_discovery_settings_invalid": "Dynamic discovery settings are corrupted: {err}",
  "error.dynamic_discovery_field_required": "Dynamic discovery field '{field}' is required",
  "error.dynamic_discovery_field_has_control_char": "Dynamic discovery field '{field}' contains a control character",
  "error.dynamic_discovery_duplicate_id": "Duplicate dynamic discovery source id: {id}",
  "error.dynamic_discovery_parse_failed": "Failed to parse {platform} discovery output from {command} at line {line}: {err}",
  "error.dynamic_discovery_connector_invalid": "Dynamic discovery connector is invalid",
  ...
  "error.sync_password_empty": "Sync password cannot be empty",
  "error.sync_auto_pull_password_missing": "Automatic pull is enabled, but its decryption password is missing",
  "error.sync_metadata_invalid": "Remote sync metadata is invalid",
  ...
  "shortcuts.goto_tab": "Switch to tab 1–9",
  ...
  "sync.auto_pull_password": "Enter Automatic Pull Password",
  ...
  "sync.auto_pull": "Automatic pull",
  "sync.auto_pull_hint": "Pull automatically when this remote has a newer version.",
  "sync.auto_pull_github": "Enable automatic pull from GitHub",
  "sync.auto_pull_webdav": "Enable automatic pull from WebDAV",
  ...
  "settings.cli.outdated": "Update available",
  "settings.cli.version": "Installed v{installed} · bundled v{expected}",
  "settings.cli.version_unknown": "unknown",
  "settings.cli.status_error": "Failed to check CLI status",
  ...
  "settings.cli.cmd.version": "Print the CLI version",
  ...
  "settings.cli.cmd.ls_group": "List connection groups",
  ...
  "settings.cli.cmd.add_group": "Create group (interactive)",
  ...
  "settings.cli.cmd.edit_group": "Edit group",
  ...
  "settings.cli.cmd.rm_group": "Delete group",
  ...
  "settings.cli.cmd.webdav_set": "Configure WebDAV sync",
  "settings.cli.cmd.webdav_push": "Push config to WebDAV",
  "settings.cli.cmd.webdav_pull": "Pull config from WebDAV",
